...
<div>
  <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-4 place-content-center max-w-screen-lg m-auto px-4 lg:px-0 font-display mt-12 mb-12">
    ...
    <div class=" flex space-x-2 space-y-2 flex-wrap lg:justify-end text-xs items-end lg:mt-0 mt-5">
    ...
    <ul class="grid grid-cols-3 gap-8 m-8" v-if="this.selected.length > 0" :key="compKey">
...
export default {
  ...
  data() {
      return {
          selected: ["Front-end", "Programming", "Career", "Miscellaneous"],
          compKey: 0,
      };
  },
